...
## Match JSON examples (maps, teams, workshop)

If you’re integrating ME with an external controller (like MAT), you’ll typically load matches using `matchzy_loadmatch_url`.

- Match JSON examples (including workshop maps): **[Integration endpoints](/docs/me/user/integration-endpoints)**
- Workshop map details: **[Maps (including workshop)](/docs/me/user/maps)**
