...
- Remove cs2-tui binary and enhance TmuxManager to derive game and TV ports from autoexec.cfg, ensuring compatibility with legacy launch flags for server startup. Update command execution in Debug method to reflect new port handling.
...
- Implement Go-based CLI for CS2 Server Manager and remove legacy scripts
