...
Notable changes in each release of [MatchZy Auto Tournament](https://github.com/sivert-io/matchzy-auto-tournament), written by hand. For the commits behind a version, see its [release on GitHub](https://github.com/sivert-io/matchzy-auto-tournament/releases).
