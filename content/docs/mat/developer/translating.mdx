...
Then open [http://localhost:3069](http://localhost:3069), pick your language in the switcher, and click through the main pages.

## More details

For deeper information (terminology guidance, MUI locale support, etc.), see:

- [i18n and translation](/docs/mat/developer/i18n-and-translation)
